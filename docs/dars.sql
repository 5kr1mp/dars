...
CREATE PROCEDURE sp_staff_create(
    ...
    IN p_password       VARCHAR(255),   -- pass pre-hashed value
...
BEGIN
    INSERT INTO staff (email, password, first_name, middle_name, last_name, user_role, contact_number)
    VALUES (p_email, p_password, p_first_name, p_middle_name, p_last_name, p_user_role, p_contact_number);
